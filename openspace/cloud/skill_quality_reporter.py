...
class CloudSkillQualityReporter:
    ...
    The MVP fallback signal is trajectory-derived and conservative. In a
    failed multi-skill trajectory, every reported skill is marked incomplete
    until a structured per-skill outcome exists.
    """
